			...
			<header className="header-style-11">
				<nav className={`navbar navbar-expand-lg navbar-light w-100 ${scroll ? 'navbar-stick position-fixed top-0' : ''}`}>
					<div className="container-fluid">
						<Link className="navbar-brand pe-4" href="/"><img src="/assets/imgs/template/graixl-logo" alt="" /></Link>
						<ul className="navbar-nav gap-1 align-items-lg-center m-auto">
							{/* <li className="nav-item  menu-item-has-children">
								<Link className="nav-link fw-medium" href="/" role="button"  aria-expanded="false">Home</Link>
