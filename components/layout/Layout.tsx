...
export default function Layout({ headerStyle, footerStyle, breadcrumbTitle, children }: LayoutProps) {
	...
	useEffect(() => {
		...
		AOS.init({
			duration: 2000, // values from 0 to 3000, with step 50ms (default is 400)
	...
	return (
		<>
			<div id="top" />
			<Header11 scroll={scroll} isMobileMenu={isMobileMenu} handleMobileMenu={handleMobileMenu} isSearch={isSearch} handleSearch={handleSearch} />
