					...
					<div style={{ visibility: 'hidden' }} className="container">
						<div className="box-newsletter-footer">
							<div className="newsletter-left">
								<div className="mb-3">
									<Link href="#"><img src="/assets/imgs/template/graixl-logo" /></Link>
								</div>
								<span className="sub-heading-sm color-white"> AI-Powered Recruitment Solutions
								</span>
							</div>
								...
								<div className="row">
									<div className="col-lg-3 col-md-6">
										...
										<div className="d-flex flex-column align-items-start">
											...
											<Link className="hover-effect paragraph-base grey-100 pt-2" href="/cookie-policy">Cookie policy</Link>
											<Link className="hover-effect paragraph-base grey-100 pt-2" href="/blogs">Our Blog</Link>
											<Link className="hover-effect paragraph-base grey-100 pt-2" href="/privacy-policy
											">Privacy Policy</Link>
										</div>
									</div>
									<div className="col-lg-3 col-md-6">
										...
										<div className="pt-4">
											...
											<p className="text-inline">
												<Link href="/mailto:support@realco.com">
													...
													<span className="color-white-70 paragraph-rubik-r">admin@graixl.com</span>
												</Link>
											</p>
											<p className="text-inline">
												...
												<span className="color-white-70 paragraph-rubik-r">Astonia</span>
											</p>
										</div>
									</div>
								</div>
							...
							<div className="footer-bottom">
								<div className="row paragraph-base">
									<div className="col-sm-6 col-12 text-center text-md-start">
										<div className="small color-white">Copyright © Graixl {new Date().getFullYear()} . Alright Reserved.</div>
									</div>
