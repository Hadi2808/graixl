...
export default function AboutUs({ id }: { id: string }) {
    ...
    return (
        <>
            ...
            <section className="box-section box-about-us-2" id={id}>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6">
                            <div className="box-info-about-top">
                                <div className="banner-small-title-black line-primary-1400">About Graixl</div>
                                <h2 className="heading-ag-3xl dark-950 mb-3">
                                    Innovative Solutions <br className="d-none d-lg-block" />
                                    with Expertise
                                </h2>
                            </div>
                            <div className="box-info-about-line">
                                <p className="mb-20 paragraph-rubik-r neutral-1700">At Graixl, we are a team of industry veterans with extensive experience across various domains. Our passion for technology and deep understanding of market trends empower us to create innovative solutions that shape the future.</p>
