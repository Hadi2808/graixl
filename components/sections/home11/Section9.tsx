					...
					<div className="container">
						<div className="row position-relative align-items-end">
							...
							<div className="col-lg-5 mb-4 text-center text-lg-start">
								<p className="paragraph-rubik-r dark-950">Fully automated, and efficient interviews that feel like speaking with a real interviewer. Saves your time by focusing on the best candidates and reduce hiring costs by up to 80% with Graixl.</p>
							</div>
						</div>
									...
									<div className="swiper-wrapper">
										<SwiperSlide>
											<div className="card-blog card-blog-2 card-blog-10">
												<div className="card-image">
													...
													<span className="card-date">AI Recruitment</span>
												</div>
												<div className="card-info">
													...
													<div className="card-title">
														<Link href="#" className="link-title heading-ag-lg">Why Voice AI is the Future of Recruitment- Automation of initial screening</Link>
										...
										<SwiperSlide>
											<div className="card-blog card-blog-2 card-blog-10">
												<div className="card-image">
													<Link href="#"><img className="wow img-custom-anim-top" src="/assets/imgs/pages/home11/news2.png" alt="Vatech" /></Link>
													<span className="card-date">Efficient Hiring</span>
												</div>
												<div className="card-info">
													<div className="card-meta">
														{/* <span className="comment">Comments</span>
													...
													<div className="card-title">
														<Link href="#" className="link-title heading-ag-lg">How to Interview 100 Candidates
															in a Day (Without Losing Your Mind)</Link>
														<Link href="#" className="btn btn-border-950">Read More
															<svg width={24} height={14} viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
																<path d="M16 13.9922C16 13.2502 16.733 12.1422 17.475 11.2122C18.429 10.0122 19.569 8.96519 20.876 8.16619C21.856 7.56719 23.044 6.99219 24 6.99219M24 6.99219C23.044 6.99219 21.855 6.41719 20.876 5.81819C19.569 5.01819 18.429 3.97119 17.475 2.77319C16.733 1.84219 16 0.732187 16 -0.00781285M24 6.99219L3.0598e-07 6.99219" stroke="currentColor" strokeWidth={2} />
															</svg>
										...
										<SwiperSlide>
											<div className="card-blog card-blog-2 card-blog-10">
												<div className="card-image">
													<Link href="#"><img className="wow img-custom-anim-top" src="/assets/imgs/pages/home11/news2.png" alt="Vatech" /></Link>
													<span className="card-date">AI Perceptions</span>
												</div>
												<div className="card-info">
													<div className="card-meta">
														{/* <span className="comment">Comments</span>
													...
													<div className="card-title">
														<Link href="#" className="link-title heading-ag-lg">What Candidates Really Think of AI Interviews – Surprising Insights</Link>
														<Link href="#" className="btn btn-border-950">Read More
															<svg width={24} height={14} viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
																<path d="M16 13.9922C16 13.2502 16.733 12.1422 17.475 11.2122C18.429 10.0122 19.569 8.96519 20.876 8.16619C21.856 7.56719 23.044 6.99219 24 6.99219M24 6.99219C23.044 6.99219 21.855 6.41719 20.876 5.81819C19.569 5.01819 18.429 3.97119 17.475 2.77319C16.733 1.84219 16 0.732187 16 -0.00781285M24 6.99219L3.0598e-07 6.99219" stroke="currentColor" strokeWidth={2} />
															</svg>
										...
										<SwiperSlide>
											<div className="card-blog card-blog-2 card-blog-10">
												<div className="card-image">
													<Link href="#"><img className="wow img-custom-anim-top" src="/assets/imgs/pages/home11/news2.png" alt="Vatech" /></Link>
													<span className="card-date">Screening Methods</span>
												</div>
												<div className="card-info">
													<div className="card-meta">
														{/* <span className="comment">Comments</span>
													...
													<div className="card-title">
														<Link href="#" className="link-title heading-ag-lg">Voice vs Video vs Text: What’s the Best Format for Pre-Screening?</Link>
														<Link href="#" className="btn btn-border-950">Read More
															<svg width={24} height={14} viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
																<path d="M16 13.9922C16 13.2502 16.733 12.1422 17.475 11.2122C18.429 10.0122 19.569 8.96519 20.876 8.16619C21.856 7.56719 23.044 6.99219 24 6.99219M24 6.99219C23.044 6.99219 21.855 6.41719 20.876 5.81819C19.569 5.01819 18.429 3.97119 17.475 2.77319C16.733 1.84219 16 0.732187 16 -0.00781285M24 6.99219L3.0598e-07 6.99219" stroke="currentColor" strokeWidth={2} />
															</svg>
										...
										<SwiperSlide>
											<div className="card-blog card-blog-2 card-blog-10">
												<div className="card-image">
													<Link href="#"><img className="wow img-custom-anim-top" src="/assets/imgs/pages/home11/news2.png" alt="Vatech" /></Link>
													<span className="card-date">Fair Recruitment</span>
												</div>
												<div className="card-info">
													<div className="card-meta">
														{/* <span className="comment">Comments</span>
													...
													<div className="card-title">
														<Link href="#" className="link-title heading-ag-lg">5 Ways to Make Your Hiring Process Bias-Free in 2025</Link>
														<Link href="#" className="btn btn-border-950">Read More
															<svg width={24} height={14} viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
																<path d="M16 13.9922C16 13.2502 16.733 12.1422 17.475 11.2122C18.429 10.0122 19.569 8.96519 20.876 8.16619C21.856 7.56719 23.044 6.99219 24 6.99219M24 6.99219C23.044 6.99219 21.855 6.41719 20.876 5.81819C19.569 5.01819 18.429 3.97119 17.475 2.77319C16.733 1.84219 16 0.732187 16 -0.00781285M24 6.99219L3.0598e-07 6.99219" stroke="currentColor" strokeWidth={2} />
															</svg>
