...
import Ticker from '@/components/sections/home14/Section4'
...
export default function Section4({ id }: { id: string }) {
	...
	return (
		<>
			...
			<section className="position-relative overflow-hidden box-section box-case-studies-2" id={id}>
				<div className="container" data-aos="fade-up">
					<div className="text-center d-flex flex-column align-items-center">
						...
						<h2 className="heading-ag-3xl dark-950">Import jobs
							<br className="d-none d-lg-block" /> and invite candidates</h2>
						<div className="w-50">
							<p className="mb-40 paragraph-rubik-r neutral-1700">
								Works with any ATS—zero setup. Automate screening while keeping your workflow. Fast, simple, and fully compatible. simplicity.</p>
						</div>
					</div>
				...
				<div className="box-list-studies">
