				...
				<div className="box-banner-11-inner">
					<div className="container">
						<div className="banner">
							...
							<h1 className="display-ag-2xl gray-1100 mb-3" data-aos="fade-up"><span>Revolutionizing Recruitment with Voice AI </span>Consulting with <strong className="primary-1200">Graixl. </strong></h1>
							<p className="paragraph-rubik-r gray-800 desc-banner" data-aos="fade-up">Empowering companies with AI-driven, unbiased, and scalable candidate assessments.</p>
